...
class PeopleController {
    ...
    @GetMapping("/people")
    List<People> displayAllPeople() {
        return repository.findAll();
    }
    // end::get-aggregate-root[]

    @PostMapping("/people")
    People addPeople(@RequestBody People newPeople) {
    ...
    People displayPeople(@PathVariable Long id) {
    ...
    void removePeople(@PathVariable Long id) {
